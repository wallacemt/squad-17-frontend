...
export const metadata: Metadata = {
  ...
  description: "Publication information for Microsoft Store, Terms of Use and Privacy Policy for Critix Vault.",
};

export default function CritixVaultPoliciesAndTermsPage() {
  const msStoreUrl = process.env.NEXT_PUBLIC_CRITIX_VAULT_MS_STORE_URL ?? "https://apps.microsoft.com/";
