      ...
      <div className="relative w-full flex flex-col">
        ...
        <input
          ...
          className={cn(
            ...
            !!error &&
              "border-color-danger focus:border-color-danger focus:ring-danger-crx/20",
            !!icon && "pl-11",
            className
          )}
          ref={ref}
        ...
        />
        {!!error && showError && (
          <p className="mt-1.5 text-xs text-danger-crx font-bold animate-in fade-in duration-200">
            {error}
          </p>
        )}
      </div>
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className={cn(
            ...
            "disabled:cursor-not-allowed disabled:opacity-50",
            !!error &&
              "border-danger-crx focus:border-danger-crx focus:ring-danger-crx/20",
            !!icon && "pl-11",
            className
          )}
          ref={ref}
