    ...
    >
      ...
      <div className="space-y-4">
        <div className="text-center">
          <h1 className="font-display text-3xl font-bold text-primary-crx mb-2">
            Escolha sua conta
          </h1>
          <p className="text-text-secondary-crx">
            Acesse rapidamente com sua conta favorita
          </p>
        </div>
      </div>
        ...
        <CardContent>
          <div className="flex items-center gap-3 text-sm text-text-secondary-crx">
            ...
            <div>
              ...
              <p className="text-xs">
                Usamos OAuth 2.0 para garantir que suas credenciais nunca sejam
                compartilhadas. Apenas seu nome e email serão utilizados.
              </p>
            </div>
          </div>
        </CardContent>
