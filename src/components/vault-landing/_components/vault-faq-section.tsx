...
export function VaultFaqSection({ msStoreUrl, repositoryUrl }: VaultFaqSectionProps) {
  return (
    <section id="faq" className="mx-auto max-w-7xl scroll-mt-24 px-4 pt-20 pb-28 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        ...
        <h2 className="font-display text-4xl md:text-6xl">Duvidas frequentes</h2>
      </motion.div>
      ...
      >
        <BorderGradientPanel>
          <div className="grid gap-5 px-6 py-7 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              <p className="text-text-muted text-sm uppercase tracking-[0.18em]">Pronto para testar</p>
              <h3 className="mt-2 font-display text-3xl">Leve sua biblioteca local para outro nivel</h3>
              <p className="mt-2 text-text-secondary">
                Comece agora pela Microsoft Store e acompanhe as proximas versoes na integra com GitHub.
              </p>
            </div>
