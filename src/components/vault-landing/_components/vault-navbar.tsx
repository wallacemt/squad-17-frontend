    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-bg-surface/75 backdrop-blur-xl">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-6 px-4 sm:px-6 lg:px-8">
        <Link href="#visao" className="flex hover:scale-105 transition-all items-center  group cursor-pointer">
          <Image src={"/images/logo-full.png"} width={100} height={100} alt="Critix Logo" title="Critix" className="" />
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <Link
            href="/critix-vault/polices-terms"
            className="rounded-full border border-primary-crx/30 bg-primary-crx/10 px-3 py-1.5 text-sm text-primary-crx transition-all hover:border-primary-crx hover:text-primary-crx"
          >
            Polices & Terms
          </Link>
        </div>
